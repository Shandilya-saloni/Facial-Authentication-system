    ...
    def fill_attendance():
        ...
        if subb=='':
            ...
            def create_csv():
                ...
                connection.commit()
                csv_name='C:/Users/praty/Downloads/attendance-system-by-face-recognition-in-python-master/attendance-system-by-face-recognition-in-python-master'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(r'explorer /select,"C:/Users/praty/Downloads/attendance-system-by-face-recognition-in-python-master/attendance-system-by-face-recognition-in-python-master-"')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='snow')
                cs = 'C:/Users/praty/Downloads/attendance-system-by-face-recognition-in-python-master/attendance-system-by-face-recognition-in-python-master/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(r'explorer /select,"C:/Users/praty/Downloads/attendance-system-by-face-recognition-in-python-master/attendance-system-by-face-recognition-in-python-master/-------Check atttendance-------"')
